...
from abraxas.core.projects import list_project_folders, purge_project_folder, get_projects_dir, check_project_unsaved_changes
    ...
    def confirm_purge_folder(self, folder_data: dict):
        ...
        if box.clickedButton() == btn_confirm:
            try:
                ...
                try:
                    from abraxas.core.paths import get_project_order_file
