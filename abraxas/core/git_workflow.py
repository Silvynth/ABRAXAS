...
from abraxas.core.ai import get_configured_model, get_model_skill, generate_with_model
...
def get_git_identity(project_path: str = None) -> Tuple[str, str]:
    ...
    if not name or not email:
        try:
            from abraxas.core.setup import read_toml_dict, get_target_config_path
    ...
    if not name or not email:
        try:
            from abraxas.core.setup import detect_git_identity
